...
impl ConfidentialComputeRecord {
    ...
    pub fn from_tx_request(
        ...
        Self {
            ...
            gas: tx_req.gas.map(|g| g.try_into().expect("Overflowing gas param")).unwrap_or(0),
    ...
    pub fn has_missing_field(&self) -> bool {
        self.confidential_inputs_hash.is_none() || self.r.is_none() || self.s.is_none() || self.v.is_none()
    }
...
impl From<&ConfidentialComputeRecord> for CcRecordRlp {
    fn from(ccr: &ConfidentialComputeRecord) -> Self {
        Self {
            ...
            confidential_inputs_hash: ccr.confidential_inputs_hash.expect("Missing confidential_inputs_hash"),
...
impl From<&ConfidentialComputeRequest> for CcrHashingParams {
    fn from(ccr: &ConfidentialComputeRequest) -> Self {
        Self {
            ...
            confidential_inputs_hash: ccr.confidential_compute_record.confidential_inputs_hash.expect("Missing confidential_inputs_hash"),
...
use std::sync::Arc;
use alloy::network::{TxSigner, NetworkSigner, Network, TransactionBuilder, BuilderResult, TransactionBuilderError};
...
impl TransactionBuilder<SuaveNetwork> for ConfidentialComputeRequest {
    ...
    async fn build<S: NetworkSigner<SuaveNetwork>>(
        ...
        // map alloy::signers::Error to TransactionBuilderError error (TransactionBuilder::Signer = alloy::signers::Error)
